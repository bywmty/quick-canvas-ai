...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div
        className="absolute top-1/3 right-1/3 w-3 h-3 rounded-full bg-primary/60 animate-pulse-glow"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-1/4 left-1/3 w-2 h-2 rounded-full bg-accent animate-pulse-glow"
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative w-[500px] h-[500px]">
              ...
              {["top", "bottom", "left", "right"].map((side) => {
                ...
                return (
                  <div
                    ...
                    className={`absolute ${
                      side === "top"
                        ? "top-[16%] left-[22%] right-[22%] h-5"
                        : side === "bottom"
                        ? "bottom-[16%] left-[22%] right-[22%] h-5"
                        : side === "left"
                        ? "left-[16%] top-[22%] bottom-[22%] w-5"
              ...
              <motion.div
                className="absolute -bottom-0 -left-20 px-3 py-1 glass-card rounded-lg text-xs text-primary border border-primary/30 font-mono"
                animate={{ x: [0, -10, 0], opacity: [0.7, 1, 0.7] }}
                transition={{ duration: 3, repeat: Infinity, delay: 1.5 }}
              >
                <span className="text-accent">◆</span>Quick Context
              </motion.div>
            </div>
          </motion.div>
        </div>
